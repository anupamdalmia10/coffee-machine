...
func (c *coffeeV1) checkIngredients(beverage string, id int) (bool, []string) {
...
func (c *coffeeV1) reserveIngredients(beverage string, id int) {
...
func (c *coffeeV1) inlet(ing <-chan map[string]int) {
...
func (c *coffeeV1) outlet(id int, bvg <-chan string) {
	defer c.wg.Done() // Tell the WorkGroup that lifespan of this inlet is over, right after exiting from this block
...
func (c *coffeeV1) InitialiseMachine() {
...
func (c *coffeeV1) ExecuteCommands(bvg chan<- string, refill chan<- map[string]int) {
